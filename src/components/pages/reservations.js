          ...
          <div className="reservations-list-container">
            ...
            {sortedReservations.length !== 0 ? (
              ...
              <div className="no-reservations-container">
                ...
                <Link to="/motorcycles" className="no-reservations-link">Click here to reserve a motorcycle</Link>
              </div>
            )}
          </div>
        ) : (
          <div className="popup_msg">
            <p className="popup_msg_text">You need to be logged in to see your reservations</p>
          </div>
        )}
      </div>
    </div>
